---
title: "À Propos"
description: "Christian Boulet - 28 ans d'expérience technologique, fondateur de Boulet Stratégies TI. Direction technologique fractionnée pour PME québécoises ambitieuses."
---

# Christian Boulet
## Directeur Technologique Fractionné
...
### 1. Je Parle Business, Pas Jargon

**Mon talent #1** : Traduire l'ambiguïté technologique en décisions d'affaires claires.

Vous n'avez pas besoin d'un expert qui vous explique Docker et Kubernetes. Vous avez besoin de quelqu'un qui vous dit : **"Voici les 3 options, voici les risques, voici les coûts, voici ma recommandation. Décidez demain matin."**

C'est ce que je fais depuis 28 ans.

### 2. Je Débloque, Je Ne Génère Pas de Rapports
...
Je ne suis pas un consultant externe qui arrive avec une checklist générique.

**J'ai négocié avec les mêmes fournisseurs que vous.**
**J'ai structuré les mêmes équipes que vous.**
**J'ai géré les mêmes migrations critiques que vous.**

La différence ? Je l'ai fait pendant 28 ans, dans plusieurs industries, avec des dizaines de millions de dollars de budgets tech.

---

## Ma Personnalité (ENTP-A - The Innovator)

**Profil Myers-Briggs** : ENTP-A (Assertif)
...
C'est exactement ce que j'offre : **L'expertise d'un CTO chevronné, dans un format flexible et accessible.**

---

## Mon Approche

### Les 3 Principes Qui Me Guident

**1. Zéro Jargon**
Je parle en langue d'affaires. ROI, risques, coûts, timeline. Pas en Docker, Kubernetes, microservices.
...
**Famille** : Marié, père de famille. Je cuisine régulièrement pour ma famille et mes amis (BBQ, plancha, four, poêle - je me débrouille bien 😉).
...
[**→ Réserver 30 Min sur Calendly**](https://calendly.com/christian-bouletstrategies)

Ou contactez-moi directement : [christian@bouletstrategies.ca](mailto:christian@bouletstrategies.ca)
